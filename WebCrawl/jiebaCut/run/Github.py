...
def cut(rows):
    map = {}
    for row in rows:
        response = requests.get(url=row[2], headers=headers).content
...
def writeToDatabase(List):
    ...
    userName2 = 'root'
    passWord2 = 'lzq2686105'
    conn2 = pymysql.connect(host=serverName2, user=userName2, password=passWord2, database="github", charset='utf8mb4')
